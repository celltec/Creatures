...
/*
    ...
    {
    #line 24 ""
        gl_Position = mul(float4(IN_pos + (IN_uv * IN_radius), 0.0f, 1.0f), _20_mvp);
        FRAG.uv = IN_uv;
    #line 26 ""
        FRAG.fill = IN_fill;
    #line 27 ""
        float3 _61 = FRAG.fill.xyz * IN_fill.w;
...
static const char vs_source_hlsl5[1399] = {
    ...
    0x30,0x66,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x2c,0x20,0x5f,0x32,0x30,0x5f,0x6d,
    ...
    0x6c,0x6f,0x61,0x74,0x33,0x20,0x5f,0x36,0x31,0x20,0x3d,0x20,0x46,0x52,0x41,0x47,
    ...
    0x31,0x2e,0x78,0x2c,0x20,0x5f,0x36,0x31,0x2e,0x79,0x2c,0x20,0x5f,0x36,0x31,0x2e,
